package com.bank.islamic.profitequalizationreserve.model;
...
/**
 * The BIAN control record for this service domain: "Profit Equalization Reserve Management Plan".
 *
 ...
 * to its asset type (Profit Equalization Reserve). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Profit Equalization Reserve Management Plan";
